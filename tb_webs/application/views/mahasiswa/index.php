                        ...
                        <table class="table table-striped table-bordered table-hover" id="tableMahasiswa">
                            ...
                            <tbody>
                                <?php foreach ($data_mahasiswa as $row) : ?>
                                    <tr>
                                        <td>
                                            <a href="<?= site_url('mahasiswa/edit/' . $row->IdMhs) ?>" class="btn btn-success btn-sm"><i class="fa fa-edit"></i> </a>
                                            <a href="javascript:void(0);" data="<?= $row->IdMhs ?>" class="btn btn-danger btn-sm item-delete"><i class="fa fa-trash"></i> </a>
                                        </td>
                                        <td><?= $row->Nama ?></td>
